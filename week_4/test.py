...
from draw2d import start_drawing, draw_oval, finish_drawing, draw_rectangle
import random
...
def main():
    ...
    for i in range(15):
        x = random.randint(15, scene_width - max_diam)
        y = random.randint(100, half_height)
        diameter = random.randint(20, 40)
        draw_rectangle(canvas, x, y, x + diameter, y + diameter,
                fill="orange4")
